...
<body ng-app="myApp">
					    		...
					    		<div class="layui-tab-content article-goods">
					    			...
					    			<div class="layui-form-item" style="margin-top: 10px;">
										<div class="layui-inline" style="width: 100%;">
											<label class="layui-form-label" style="border: 0;background-color: #fff;background-color: #FBFBFB;line-height: 20px;border: 1px solid #e6e6e6;border-radius: 2px 0 0 2px;top: 34px;">推荐理由</label>
									...
									<div class="layui-form-item" style="margin-top: 10px;">
										<div class="layui-inline">
											<label class="layui-form-label"><b>*</b>参考价格</label>
											<div class="layui-input-inline" style="width: 90px;">
												<input type="text" class="layui-input" ng-model="price" placeholder="输入参考价格" />
											</div>
										</div>
										<div class="layui-inline">
	...
	<script type="text/javascript" src="../../js/detailsCustomProduct.js"></script>
</body>
</html>